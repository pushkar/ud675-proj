"""
The following code shows you how to use the sci-kit library for Machine Learning
In this example we will learn a decision tree and then predict the output of a particular instance
"""
